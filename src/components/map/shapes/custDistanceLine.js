...
export const CustDrawLine= React.memo(({ shapeProps ,onSelect}) => {
    ...
    return (
        <React.Fragment>
            ...
            <Line
              ...
              strokeWidth={shapeProps.strokeWidth==null?5:shapeProps.strokeWidth}
              lineCap="round"
           ...
           {shapeProps.points.map((coord, i) => (
                <Circle
                    ...
                    fill="blue"
                    rotateEnabled={false}
                    strokeWidth={i==0 &&  shapeProps.points.length>2 && areIntersecting(shapeProps.points[shapeProps.points.length-1],shapeProps.points[0])==true?shapeProps.strokeWidth+10:0}
