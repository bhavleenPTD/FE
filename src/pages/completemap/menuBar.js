...
export default (props) => {
	...
	return (
		<div className="p-3" style={{ backgroundColor: '#E5E5E5' }}>
                ...
                <div style={{fontSize:"11px",width: "200px"}} >
                  <div style={{margin:"auto"}} className="d-flex justify-content-between">
                      <div className="d-flex">
                            ...
                            <div style={{ backgroundColor: "white", minWidth: "20px", padding: "5px 10px 5px 5px", borderTopRightRadius: "20%", borderBottomRightRadius: "20%" }}>{hoverLatLng.lat.toFixed(4)}</div></div>
                            <div className="d-flex">
                            ...
                            <div style={{ backgroundColor: "white", minWidth: "20px", padding: "5px 10px 5px 5px", borderTopRightRadius: "20%", borderBottomRightRadius: "20%" }}>{hoverLatLng.long.toFixed(4)}</div>
                   </div>   </div>  </div>:null}
				</div>
			</div>
