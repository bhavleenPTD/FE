...
import AnnotationMenu from './AnnotationMenu/bbMenu';
  ...
  const crop=()=> {
   ...
   if(height<0){
       ...
       //  console.log(stageRef);
        ...
        inputImage.onload = () => {
          ...
          // console.log('coordinates',x,y,outputWidth,outputHeight);
            ...
            resolve({outputImage,inputHeight,inputWidth,x,y,width,height});
        };
    ...
    pr.then(data=>{
     ...
     let image= data.outputImage.toDataURL();
       props.navigateToMap({image:image,
   ...
   e=>{
     ...
     stage.container().style.cursor="default";
      ...
      let newobj={...obj};
        ...
        >
          <BaseImage imagepath={props.imagepath}/> 
        ...
        <div className="zoom-container" style={{position:'fixed',top:'7.8rem'}}>
