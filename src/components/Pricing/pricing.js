...
class Pricing extends Component {
    constructor(props) {
        ...
        this.state = {
            pricings : [
               { title : "Economy", price : 9.90, duration : "MONTH",
                    features : [
                ...
                { title : "DELUXE", price : 19.90, duration : "Mo", isActive :true,
                    features : [
                ...
                { title : "ULTIMATE", price : 29.90, duration : "Mo",
                    features : [
        ...
        return (
            <React.Fragment>
                <section className="section pt-5" id="pricing">
                    <Container>
                        {/* section title */}
                    <SectionTitle title="Our Pricing" desc="Call to action pricing table is really crucial to your for your business website. Make your bids stand-out with amazing options." />
